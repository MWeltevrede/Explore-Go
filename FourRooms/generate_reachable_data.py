...
with open(f'config/train_reachable_space.pl', 'wb') as file:
...
with open(f'config/train_reachable_space_opt_actions.pl', 'wb') as file:
	dill.dump(optimal_actions, file)

with open(f'config/obs_to_q_values_map.pl', 'wb') as file:
